...
# ******************************************
# Xa. Remove Duplicate Reads for tumor sample
# ******************************************
...
# ******************************************
# Xb. Remove Duplicate Reads for normal sample
# ******************************************
...
# ******************************************
# 3a. Indel realigner for tumor sample
# ******************************************
$SENTIEON_INSTALL_DIR/bin/sentieon driver -r $fasta -t $nt -i tumor_sorted.bam --algo Realigner tumor_realigned.bam
# ******************************************
# 3b. Indel realigner for normal sample
# ******************************************
$SENTIEON_INSTALL_DIR/bin/sentieon driver -r $fasta -t $nt -i normal_sorted.bam --algo Realigner normal_realigned.bam
...
# ******************************************
# 5. Corealignment of tumor and normal
# ******************************************
